...
public class SQLDemoController {
	...
	Logger logger = LoggerFactory.getLogger(SQLDemoController.class);

	@Autowired
	ProductService productService;
	
	@PostMapping("/saveProduct")
	public ResponseEntity<?> saveProductAndReview(@RequestBody List<ProductAndReview> products){
		try {
			...
			ControllerException ce = new ControllerException("613","Something went wrong in controller layer");
	...
	public ResponseEntity<?> getProductById(@PathVariable("id") Long id){
		try {
			...
			ControllerException ce = new ControllerException("614","Something went wrong in controller layer");
			return new ResponseEntity<ControllerException>(ce, HttpStatus.INTERNAL_SERVER_ERROR);
		}
